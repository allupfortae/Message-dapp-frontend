...
const Sending = () => {
  // const fakeAccount = ["0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"];
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="bg-[#1f208f] w-[500px] h-[300px] flex flex-col rounded-md items-center ml-[900px] mt-20">
        <div className="flex gap-5 items-center flex-col  ">
          <h1 className="text-xl ml-6 text-white mt-6">
            Sending to: {toAccount}
          </h1>
          ...
          <button
            ...
            disabled={isFetching}
            className="bg-[#34b2ea] p-2 text-lg rounded-md text-white
           "
          >
            Send
          </button>
